        ...
        <>
            <div className={"cards-holder cards-holder-middle"} style={{height: 186}}>
                {((typeof middle !== 'undefined' && middle.length > 0) ? middle.map((item,index)=>{
                    return <Card key={index} selected={[]} int={index} type={"middle"} suit={item[0]} value={item[1]} changed={item[2]} prevCard={item[3]} setDoNextStep={props.setDoNextStep} animate={props.animate} lastStep={props.lastStep} firstStep={props.firstStep} direction={props.direction} length={props.length} />;
                }) : "")}
            </div>
            <div className={"cards-holder"}>
                {((typeof hand !== 'undefined' && hand.length > 0) ? hand.map((item,index)=>{
                    return <Card key={index} selected={props.selected ?? []} int={index} type={"hand"} suit={item[0]} value={item[1]} changed={item[2]} prevCard={item[3]} setDoNextStep={props.setDoNextStep} animate={props.animate} lastStep={props.lastStep} firstStep={props.firstStep} direction={props.direction} length={props.length} />;
                }) : "")}
            </div>
        </>
    );
