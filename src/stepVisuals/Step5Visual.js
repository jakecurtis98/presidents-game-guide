...
function Step5Visual(props) {
    ...
    return (
            <img src={'imgs/table.svg'} style={{width: '25%', display:display, margin:'auto',transition:transition, opacity:opacity}} alt={"Group"}/>
    );
}
export default Step5Visual;